  ...
  <div class="main-container">
    ...
    >
      <div class="div1">
        ...
        <span class="span2" style="cursor: pointer" @click="isTitle = true">{{ param.title }}</span>
      </div>

      <div v-if="isTitle" style="padding : 0 20px 60px 20px">
        <el-input v-model="param.title" placeholder="Please input">
