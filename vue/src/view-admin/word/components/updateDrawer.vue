  ...
  <div class="main-container">
    ...
    >
      <div class="div1">
        ...
        <span class="span2" @click="isTitle = true" style="cursor: pointer">{{param.title}}</span>
      </div>

      <div style="padding : 0 20px 60px 20px" v-if="isTitle">
        <el-input placeholder="Please input" v-model="param.title">
          <template slot="append">
            <div style="cursor: pointer" @click="titleUpdate()">
