<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="routerChange('/admin-binsoo/user')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="user.count" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="routerChange('/admin-binsoo/license')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="license.count" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="routerChange('/admin-binsoo/notice')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="notice.count" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="routerChange('/admin-binsoo/question')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="question.count" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="routerChange('/admin-binsoo/word')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="word.count" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
