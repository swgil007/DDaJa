...
export default {
  data() {
    return {
      ...
      REDIRECT_URI: 'localhost:9527/social/login',
      RESPONSE_TYPE: 'token',
  ...
  methods: {
    ...
    //   .catch(err => {
      //       console.log(err)
    //   })
      const REQUEST_URI = this.AUTHORIZE_URI + '?' + 'client_id=' + this.$googleClientID + '&redirect_uri=' + this.REDIRECT_URI + '&response_type=' + this.RESPONSE_TYPE
